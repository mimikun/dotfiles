# 🏗️ GEMINI.md - Gemini CLI Global Configuration

This file provides guidance to Gemini CLI (https://github.com/google-gemini/gemini-cli) when working across all projects.

## 📋 Overview

This is my global Gemini CLI configuration directory (`~/.gemini`) that sets up:
...
- **User Interaction**: Always communicate in Japanese (日本語) with users
