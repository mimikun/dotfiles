...
-- 全角文字の表示に2文字分使うようにする
-- https://neovim.io/doc/user/options.html#'ambiwidth'
...
-- ファイル読み込むときのエンコード
-- 左から順に試す
-- https://neovim.io/doc/user/options.html#'fileencodings'
...
-- ヘルプ日本語化
-- https://neovim.io/doc/user/options.html#'helplang'
...
-- https://neovim.io/doc/user/options.html#'wrapscan'
