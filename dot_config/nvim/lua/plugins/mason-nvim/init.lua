...
local spec = {
    ...
    config = function()
        ...
        mason_lspconfig.setup({
            ensure_installed = require("plugins.lsp.ensure_installed"),
        })
        ...
        mason_lspconfig.setup_handlers({
            ...
            ["markdown_oxide"] = function()
                lspconfig.markdown_oxide.setup(require("plugins.lsp.markdown-oxide"))
            end,
        })
        ...
        mason_nvim_dap.setup({
            ensure_installed = require("plugins.dap.ensure_installed"),
            handlers = {
                function(config)
