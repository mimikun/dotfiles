...
function __lazyworktree_perform_completion
    ...
    for line in $results
        if not string match -q -- "lazyworktree*" $line
...
# Clear existing completions for lazyworktree
complete -c lazyworktree -e
# Register completion function
complete -c lazyworktree -f -a '(__lazyworktree_perform_completion)'