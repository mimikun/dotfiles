...
complete -c aqua -n '__fish_seen_subcommand_from version' -f -l help -s h -d 'show help'
complete -r -c aqua -n '__fish_seen_subcommand_from version' -a 'help h' -d 'Shows a list of commands or help for one command'
