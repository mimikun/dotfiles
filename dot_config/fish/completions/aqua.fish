...
complete -c aqua -n '__fish_seen_subcommand_from set' -f -l stdin -d 'Read GitHub Access token from stdin'
complete -c aqua -n '__fish_seen_subcommand_from set' -f -l help -s h -d 'show help'
complete -x -c aqua -n '__fish_seen_subcommand_from set; and not __fish_seen_subcommand_from help h' -a 'help' -d 'Shows a list of commands or help for one command'
...
complete -x -c aqua -n '__fish_seen_subcommand_from allow; and not __fish_seen_subcommand_from help h' -a 'help' -d 'Shows a list of commands or help for one command'
...
complete -x -c aqua -n '__fish_seen_subcommand_from deny; and not __fish_seen_subcommand_from help h' -a 'help' -d 'Shows a list of commands or help for one command'
