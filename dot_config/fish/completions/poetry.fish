...
complete -c poetry -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -l help -d 'Display help for the given command. When no command is given display help for the list command.'
complete -c poetry -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -l no-ansi -d 'Disable ANSI output.'
complete -c poetry -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -l no-cache -d 'Disables Poetry source caches.'
...
complete -c poetry -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -l no-plugins -d 'Disables plugins.'
complete -c poetry -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -l quiet -d 'Do not output any message.'
complete -c poetry -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -l verbose -d 'Increase the verbosity of messages: 1 for normal output, 2 for more verbose output and 3 for debug.'
...
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a cache clear -d 'Clears Poetry\'s cache.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a cache list -d 'List Poetry\'s caches.'
...
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a debug info -d 'Shows debug information.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a debug resolve -d 'Debugs dependency resolution.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a env info -d 'Displays information about the current environment.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a env list -d 'Lists all virtualenvs associated with the current project.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a env remove -d 'Remove virtual environments associated with the project.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a env use -d 'Activates or creates a new virtualenv for the current project.'
...
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a help -d 'Displays help for a command.'
...
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a list -d 'Lists commands.'
...
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a self add -d 'Add additional packages to Poetry\'s runtime environment.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a self install -d 'Install locked packages (incl. addons) required by this Poetry installation.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a self lock -d 'Lock the Poetry installation\'s system requirements.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a self remove -d 'Remove additional packages from Poetry\'s runtime environment.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a self show -d 'Show packages from Poetry\'s runtime environment.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a self show plugins -d 'Shows information about the currently installed plugins.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a self update -d 'Updates Poetry to the latest version.'
...
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a source add -d 'Add source configuration for project.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a source remove -d 'Remove source configured for the project.'
complete -c poetry -f -n '__fish_poetry_c3ad9ea5785e94a5_complete_no_subcommand' -a source show -d 'Show information about sources configured for the project.'
