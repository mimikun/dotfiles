...
complete -c purple -n "__fish_purple_needs_command" -a "sync" -d 'Sync hosts from cloud providers (DigitalOcean, Vultr, Linode, Hetzner, UpCloud, Proxmox VE, AWS EC2, Scaleway, GCP, Azure, Tailscale, Oracle Cloud, OVHcloud, Leaseweb, i3D.net, TransIP, Teleport)'
...
complete -c purple -n "__fish_purple_needs_command" -a "gen-assets" -d 'Render marketing SVG screenshots from the demo TUI. Internal: drives the release imagery pipeline so README and landing-page assets never go stale'
...
complete -c purple -n "__fish_purple_using_subcommand mcp" -l audit-log -d 'Custom path for the MCP audit log (default: mcp-audit.log in the state directory, ~/.purple by default). Ignored when --no-audit is set' -r
...
complete -c purple -n "__fish_purple_using_subcommand mcp" -l no-audit -d 'Disable the MCP audit log. By default every tool call is appended to mcp-audit.log in the state directory (~/.purple by default) as JSON Lines'
...
complete -c purple -n "__fish_purple_using_subcommand gen-assets" -l font-dir -d 'Directory holding ui-mono-regular.woff2 and ui-mono-bold.woff2 to embed. Pass an empty value to render with the system monospace' -r
complete -c purple -n "__fish_purple_using_subcommand gen-assets" -l hero-out -d 'Also write the looping animated hero SVG (all five tabs with detail panels, search typing itself) to this path' -r
complete -c purple -n "__fish_purple_using_subcommand gen-assets" -s h -l help -d 'Print help'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "add" -d 'Quick-add a host: purple add user@host:port --alias myserver'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "import" -d 'Import hosts from a file or known_hosts'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "sync" -d 'Sync hosts from cloud providers (DigitalOcean, Vultr, Linode, Hetzner, UpCloud, Proxmox VE, AWS EC2, Scaleway, GCP, Azure, Tailscale, Oracle Cloud, OVHcloud, Leaseweb, i3D.net, TransIP, Teleport)'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "provider" -d 'Manage cloud provider configurations'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "tunnel" -d 'Manage SSH tunnels'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "password" -d 'Manage passwords in the OS keychain for SSH hosts'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "snippet" -d 'Manage command snippets for quick execution on hosts'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "update" -d 'Update purple to the latest version'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "mcp" -d 'Start MCP server (Model Context Protocol) for AI agent integration'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "theme" -d 'Manage color themes'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "vault" -d 'HashiCorp Vault SSH secrets engine operations (signed SSH certificates)'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "logs" -d 'View or manage log file'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "whats-new" -d 'Print release notes since a prior version'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "gen-assets" -d 'Render marketing SVG screenshots from the demo TUI. Internal: drives the release imagery pipeline so README and landing-page assets never go stale'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs whats-new gen-assets help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
