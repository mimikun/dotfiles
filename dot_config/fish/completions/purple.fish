...
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "add" -d 'Quick-add a host: purple add user@host:port --alias myserver'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "import" -d 'Import hosts from a file or known_hosts'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "sync" -d 'Sync hosts from cloud providers (DigitalOcean, Vultr, Linode, Hetzner, UpCloud, Proxmox VE, AWS EC2, Scaleway, GCP, Azure, Tailscale, Oracle Cloud, OVHcloud, Leaseweb, i3D.net, TransIP)'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "provider" -d 'Manage cloud provider configurations'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "tunnel" -d 'Manage SSH tunnels'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "password" -d 'Manage passwords in the OS keychain for SSH hosts'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "snippet" -d 'Manage command snippets for quick execution on hosts'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "update" -d 'Update purple to the latest version'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "mcp" -d 'Start MCP server (Model Context Protocol) for AI agent integration'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "theme" -d 'Manage color themes'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "vault" -d 'HashiCorp Vault SSH secrets engine operations (signed SSH certificates)'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "logs" -d 'View or manage log file'
complete -c purple -n "__fish_purple_using_subcommand help; and not __fish_seen_subcommand_from add import sync provider tunnel password snippet update mcp theme vault logs help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
