...
Docs: https://deno.land/manual@v1.40.4/basics/permissions
Examples:
  --allow-read
...
https://deno.land/manual@v1.40.4/basics/permissions
'
...
complete -c deno -n "__fish_seen_subcommand_from publish" -l no-zap -d 'Skip Zap compatibility validation'
