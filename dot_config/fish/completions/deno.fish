...
complete -c deno -n "__fish_seen_subcommand_from run" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
Docs: https://deno.land/manual@v1.36.0/basics/permissions
Examples:
  --allow-read
...
https://deno.land/manual@v1.36.0/basics/permissions
'
...
complete -c deno -n "__fish_seen_subcommand_from bench" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from bundle" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from cache" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from check" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from compile" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from eval" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from info" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from install" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from repl" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from test" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from test" -l reporter -d 'Select reporter to use. Default to \'pretty\'.' -r -f -a "{pretty	,dot	,junit	}"
...
complete -c deno -n "__fish_seen_subcommand_from vendor" -l deno-modules-dir -d 'UNSTABLE: Enables or disables the use of a local deno_modules folder for remote modules' -r -f -a "{true	,false	}"
