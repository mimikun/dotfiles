# @generated by usage-argv for `hk __complete_word__ --shell fish`

function __usage_complete_hk
    ...
    set -l out (command 'hk' __complete_word__ --shell fish --line "$line" 2>/dev/null)
...
complete -c 'hk' -f -a '(__usage_complete_hk)'
