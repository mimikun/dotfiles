# @generated by usage-argv for `fnox __complete_word__ --shell fish`

function __usage_complete_fnox
    ...
    set -l out (command 'fnox' __complete_word__ --shell fish --line "$line" 2>/dev/null)
...
complete -c 'fnox' -f -a '(__usage_complete_fnox)'
