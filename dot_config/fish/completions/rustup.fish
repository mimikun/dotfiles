...
complete -c rustup -n "__fish_rustup_needs_command" -a "toolchain" -d 'Modify or query the installed toolchains'
...
complete -c rustup -n "__fish_rustup_using_subcommand set; and not __fish_seen_subcommand_from default-host profile auto-self-update help" -s h -l help -d 'Print help'
complete -c rustup -n "__fish_rustup_using_subcommand set; and not __fish_seen_subcommand_from default-host profile auto-self-update help" -f -a "default-host" -d 'The triple used to identify toolchains when not specified'
complete -c rustup -n "__fish_rustup_using_subcommand set; and not __fish_seen_subcommand_from default-host profile auto-self-update help" -f -a "profile" -d 'The default components installed with a toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand set; and not __fish_seen_subcommand_from default-host profile auto-self-update help" -f -a "auto-self-update" -d 'The rustup auto self update mode'
complete -c rustup -n "__fish_rustup_using_subcommand set; and not __fish_seen_subcommand_from default-host profile auto-self-update help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "install" -d 'Install or update the given toolchains, or by default the active toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "uninstall" -d 'Uninstall the given toolchains'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "dump-testament" -d 'Dump information about the build'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "show" -d 'Show the active and installed toolchains or profiles'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "update" -d 'Update Rust toolchains and rustup'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "check" -d 'Check for updates to Rust toolchains and rustup'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "default" -d 'Set the default toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "toolchain" -d 'Modify or query the installed toolchains'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "target" -d 'Modify a toolchain\'s supported targets'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "component" -d 'Modify a toolchain\'s installed components'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "override" -d 'Modify toolchain overrides for directories'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "run" -d 'Run a command with an environment configured for a given toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "which" -d 'Display which binary will be run for a given command'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "doc" -d 'Open the documentation for the current toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "man" -d 'View the man page for a given command'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "self" -d 'Modify the rustup installation'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "set" -d 'Alter rustup settings'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "completions" -d 'Generate tab-completion scripts for your shell'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from install uninstall dump-testament show update check default toolchain target component override run which doc man self set completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
