...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -s m -l manifest-path -d 'The path to `pixi.toml`, `pyproject.toml`, or the workspace directory' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -s w -l workspace -d 'Name of the workspace' -r
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "activation" -d 'Commands to manage the activation of environments: the scripts that run and the environment variables that are set when an environment is activated'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "channel" -d 'Commands to manage workspace channels'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "description" -d 'Commands to manage workspace description'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "platform" -d 'Commands to manage workspace platforms'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "version" -d 'Commands to manage workspace version'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "environment" -d 'Commands to manage workspace environments'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "feature" -d 'Commands to manage workspace features'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "export" -d 'Commands to export workspaces to other formats'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "name" -d 'Commands to manage workspace name'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "register" -d 'Commands to manage the registry of workspaces. Default command will add a new workspace'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "requires-pixi" -d 'Commands to manage the pixi minimum version requirement'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel description platform version environment feature export name register requires-pixi help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
