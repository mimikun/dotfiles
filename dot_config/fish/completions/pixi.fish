...
complete -c pixi -n "__fish_pixi_needs_command" -f -a "init" -d 'Creates a new workspace or script'
...
complete -c pixi -n "__fish_pixi_needs_command" -f -a "update" -d 'Updates dependencies to newer compatible versions'
...
complete -c pixi -n "__fish_pixi_using_subcommand add" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand add" -l path -d 'The local path to use when adding a path dependency' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand a" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand a" -l path -d 'The local path to use when adding a path dependency' -r -F
...
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand auth; and __fish_seen_subcommand_from login" -l oauth -d 'Use OAuth/OIDC authentication'
...
complete -c pixi -n "__fish_pixi_using_subcommand build" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand build" -l no-hard-links -d 'Disallow hard links during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand clean; and __fish_seen_subcommand_from cache" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand clean; and __fish_seen_subcommand_from cache" -l notices -d 'Clean only the viewed channel notices cache'
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from edit" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from list" -l config-file -d 'Load configuration from this file instead of searching system and user-level paths. Project-local `<project>/.pixi/config.toml` is still merged on top' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from list" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from list" -l no-config -d 'Don\'t read system or user-level configuration files. Project-local `<project>/.pixi/config.toml` is still loaded'
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from ls" -l config-file -d 'Load configuration from this file instead of searching system and user-level paths. Project-local `<project>/.pixi/config.toml` is still merged on top' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from ls" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from ls" -l no-config -d 'Don\'t read system or user-level configuration files. Project-local `<project>/.pixi/config.toml` is still loaded'
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from prepend" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from append" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from set" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand config; and __fish_seen_subcommand_from unset" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand exec" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand exec" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand exec" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand x" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand x" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand x" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from add" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from add" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from add" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from a" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from a" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from a" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from install" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from install" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from install" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from i" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from i" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from i" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from uninstall" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from uninstall" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from uninstall" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from remove" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from remove" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from remove" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from rm" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from rm" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from rm" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from list" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from list" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from list" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from list" -l json -d 'Whether to output in JSON format'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from ls" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from ls" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from ls" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from ls" -l json -d 'Whether to output in JSON format'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from sync" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from sync" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from sync" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from s" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from s" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from s" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from update" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from update" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from update" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from upgrade-all" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from upgrade-all" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand global; and __fish_seen_subcommand_from upgrade-all" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from add" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from add" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from add" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from a" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from a" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from a" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from install" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from install" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from install" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from i" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from i" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from i" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from uninstall" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from uninstall" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from uninstall" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from remove" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from remove" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from remove" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from rm" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from rm" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from rm" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from list" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from list" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from list" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from list" -l json -d 'Whether to output in JSON format'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from ls" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from ls" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from ls" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from ls" -l json -d 'Whether to output in JSON format'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from sync" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from sync" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from sync" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from s" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from s" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from s" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from update" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from update" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from update" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from upgrade-all" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from upgrade-all" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand g; and __fish_seen_subcommand_from upgrade-all" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand init" -s s -l script -d 'Create a metadata block in a script instead of a workspace' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand import" -l no-symbolic-links -d 'Disallow symbolic links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand import" -l no-hard-links -d 'Disallow hard links during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand install" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand install" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand i" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand i" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand list" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand ls" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand lock" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand reinstall" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand publish" -l pinning-strategy -d 'Set pinning strategy' -r -f -a "semver\t'Default semver strategy e.g. `1.2.3` becomes `>=1.2.3, <2` but `0.1.0` becomes `>=0.1.0, <0.2`'
minor\t'Pin the latest minor e.g. `1.2.3` becomes `>=1.2.3, <1.3`'
major\t'Pin the latest major e.g. `1.2.3` becomes `>=1.2.3, <2`'
latest-up\t'Pin to the latest version or higher. e.g. `1.2.3` becomes `>=1.2.3`'
exact-version\t'Pin the version chosen by the solver. e.g. `1.2.3` becomes `==1.2.3`'
...
complete -c pixi -n "__fish_pixi_using_subcommand publish" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand publish" -l tls-no-verify -d 'Do not verify the TLS certificate of the server'
...
complete -c pixi -n "__fish_pixi_using_subcommand remove" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand remove" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand rm" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand rm" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand run" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand run" -l experimental -d 'Enable experimental `--script` features; currently the `conda-script` block'
...
complete -c pixi -n "__fish_pixi_using_subcommand run" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand run" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand r" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand r" -l experimental -d 'Enable experimental `--script` features; currently the `conda-script` block'
...
complete -c pixi -n "__fish_pixi_using_subcommand r" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand r" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand shell" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand shell" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand s" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand s" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand shell-hook" -l no-hard-links -d 'Disallow hard links during package installation'
complete -c pixi -n "__fish_pixi_using_subcommand shell-hook" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand task; and __fish_seen_subcommand_from add" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand task; and __fish_seen_subcommand_from a" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand tree" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand t" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand update" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand update" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand update" -s n -l dry-run -d 'Don\'t write the updated resolution or update any environment'
...
complete -c pixi -n "__fish_pixi_using_subcommand upgrade" -l no-ref-links -d 'Disallow ref links (copy-on-write) during package installation'
...
complete -c pixi -n "__fish_pixi_using_subcommand upload; and not __fish_seen_subcommand_from quetz artifactory prefix anaconda cloudsmith s3 conda-forge help" -a "s3" -d 'Options for uploading to S3'
complete -c pixi -n "__fish_pixi_using_subcommand upload; and not __fish_seen_subcommand_from quetz artifactory prefix anaconda cloudsmith s3 conda-forge help" -a "conda-forge" -d 'Options for uploading to conda-forge'
complete -c pixi -n "__fish_pixi_using_subcommand upload; and not __fish_seen_subcommand_from quetz artifactory prefix anaconda cloudsmith s3 conda-forge help" -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -s o -l owner -d 'The owner (namespace) of the Cloudsmith repository' -r
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -s r -l repo -d 'The Cloudsmith repository name' -r
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -s a -l api-key -d 'The Cloudsmith API key, if none is provided, the token is read from the keychain / auth-file' -r
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -s u -l url -d 'The URL to the Cloudsmith API server' -r
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand upload; and __fish_seen_subcommand_from cloudsmith" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -s m -l manifest-path -d 'The path to `pixi.toml`, `pyproject.toml`, or the workspace directory' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -s w -l workspace -d 'Name of the workspace' -r
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "activation" -d 'Commands to manage the activation of environments: the scripts that run and the environment variables that are set when an environment is activated'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "channel" -d 'Commands to manage workspace channels'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "dependencies" -d 'Commands to manage the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "dependency" -d 'Commands to manage the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "dep" -d 'Commands to manage the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "description" -d 'Commands to manage workspace description'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "platform" -d 'Commands to manage workspace platforms'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "version" -d 'Commands to manage workspace version'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "environment" -d 'Commands to manage workspace environments'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "feature" -d 'Commands to manage workspace features'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "export" -d 'Commands to export workspaces to other formats'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "name" -d 'Commands to manage workspace name'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "preview" -d 'Commands to manage workspace preview flags'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "register" -d 'Commands to manage the registry of workspaces. Default command will add a new workspace'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "requires-pixi" -d 'Commands to manage the pixi minimum version requirement'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and not __fish_seen_subcommand_from activation channel dependencies dependency dep description platform version environment feature export name preview register requires-pixi help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -l config-file -d 'Load configuration from this file instead of searching system and user-level paths. Project-local `<project>/.pixi/config.toml` is still merged on top' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -s m -l manifest-path -d 'The path to `pixi.toml`, `pyproject.toml`, or the workspace directory' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -s w -l workspace -d 'Name of the workspace' -r
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -l no-config -d 'Don\'t read system or user-level configuration files. Project-local `<project>/.pixi/config.toml` is still loaded'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -f -a "script" -d 'Commands to manage the `activation.scripts` list'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -f -a "scripts" -d 'Commands to manage the `activation.scripts` list'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -f -a "env" -d 'Commands to manage the `activation.env` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -f -a "list" -d 'List the activation scripts and environment variables in the manifest'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -f -a "ls" -d 'List the activation scripts and environment variables in the manifest'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from activation" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from channel" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -l config-file -d 'Load configuration from this file instead of searching system and user-level paths. Project-local `<project>/.pixi/config.toml` is still merged on top' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -s m -l manifest-path -d 'The path to `pixi.toml`, `pyproject.toml`, or the workspace directory' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -s w -l workspace -d 'Name of the workspace' -r
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -l no-config -d 'Don\'t read system or user-level configuration files. Project-local `<project>/.pixi/config.toml` is still loaded'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -f -a "add" -d 'Add dependencies to the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -f -a "a" -d 'Add dependencies to the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -f -a "list" -d 'List dependencies in the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -f -a "ls" -d 'List dependencies in the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -f -a "remove" -d 'Remove dependencies from the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -f -a "rm" -d 'Remove dependencies from the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependencies" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -l config-file -d 'Load configuration from this file instead of searching system and user-level paths. Project-local `<project>/.pixi/config.toml` is still merged on top' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -s m -l manifest-path -d 'The path to `pixi.toml`, `pyproject.toml`, or the workspace directory' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -s w -l workspace -d 'Name of the workspace' -r
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -l no-config -d 'Don\'t read system or user-level configuration files. Project-local `<project>/.pixi/config.toml` is still loaded'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -f -a "add" -d 'Add dependencies to the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -f -a "a" -d 'Add dependencies to the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -f -a "list" -d 'List dependencies in the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -f -a "ls" -d 'List dependencies in the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -f -a "remove" -d 'Remove dependencies from the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -f -a "rm" -d 'Remove dependencies from the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dependency" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -l config-file -d 'Load configuration from this file instead of searching system and user-level paths. Project-local `<project>/.pixi/config.toml` is still merged on top' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -s m -l manifest-path -d 'The path to `pixi.toml`, `pyproject.toml`, or the workspace directory' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -s w -l workspace -d 'Name of the workspace' -r
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -l no-config -d 'Don\'t read system or user-level configuration files. Project-local `<project>/.pixi/config.toml` is still loaded'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -f -a "add" -d 'Add dependencies to the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -f -a "a" -d 'Add dependencies to the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -f -a "list" -d 'List dependencies in the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -f -a "ls" -d 'List dependencies in the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -f -a "remove" -d 'Remove dependencies from the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -f -a "rm" -d 'Remove dependencies from the `[workspace.dependencies]` table'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from dep" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from platform" -s s -l script -d 'The path to a script with an embedded manifest: a Python script containing PEP 723 metadata, or a file of any language containing a `/// conda-script` block' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from export" -s w -l workspace -d 'Name of the workspace' -r
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -l config-file -d 'Load configuration from this file instead of searching system and user-level paths. Project-local `<project>/.pixi/config.toml` is still merged on top' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -s m -l manifest-path -d 'The path to `pixi.toml`, `pyproject.toml`, or the workspace directory' -r -F
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -s w -l workspace -d 'Name of the workspace' -r
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -l color -d 'Whether the log needs to be colored' -r -f -a "always\t''
never\t''
auto\t''"
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -l no-config -d 'Don\'t read system or user-level configuration files. Project-local `<project>/.pixi/config.toml` is still loaded'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -s h -l help -d 'Display help information'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -s v -l verbose -d 'Increase logging verbosity (-v for warnings, -vv for info, -vvv for debug, -vvvv for trace)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -f -a "add" -d 'Add preview flag(s) to the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -f -a "a" -d 'Add preview flag(s) to the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -f -a "list" -d 'List the enabled preview flags'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -f -a "ls" -d 'List the enabled preview flags'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -f -a "remove" -d 'Remove preview flag(s) from the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -f -a "rm" -d 'Remove preview flag(s) from the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from preview" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from register" -s p -l path -d 'Path to register. Defaults to the path to the current workspace' -r -F
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from register" -s q -l quiet -d 'Decrease logging verbosity (quiet mode)'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from register" -l no-progress -d 'Hide all progress bars, always turned on if stderr is not a terminal'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from register" -f -a "list" -d 'List the registered workspaces'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from register" -f -a "ls" -d 'List the registered workspaces'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from register" -f -a "remove" -d 'Remove a workspace from registry'
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from register" -f -a "rm" -d 'Remove a workspace from registry'
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from help" -f -a "activation" -d 'Commands to manage the activation of environments: the scripts that run and the environment variables that are set when an environment is activated'
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from help" -f -a "dependencies" -d 'Commands to manage the `[workspace.dependencies]` table'
...
complete -c pixi -n "__fish_pixi_using_subcommand workspace; and __fish_seen_subcommand_from help" -f -a "preview" -d 'Commands to manage workspace preview flags'
...
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "add" -d 'Adds dependencies to the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "auth" -d 'Login to prefix.dev or anaconda.org servers to access private channels'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "build" -d 'Build a conda package from a Pixi package.'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "clean" -d 'Cleanup the environments'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "completion" -d 'Generates a completion script for a shell'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "config" -d 'Configuration management'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "exec" -d 'Run a command and install it in a temporary environment'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "global" -d 'Subcommand for global package management actions'
...
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "init" -d 'Creates a new workspace or script'
...
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "self-update" -d 'Update pixi to the latest version or a specific version'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "shell" -d 'Start a shell in a pixi environment, run `exit` to leave the shell'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "shell-hook" -d 'Print the pixi environment activation script'
...
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init import install list lock reinstall publish remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a "update" -d 'Updates dependencies to newer compatible versions'
...
complete -c pixi -n "__fish_pixi_using_subcommand help; and __fish_seen_subcommand_from workspace" -f -a "activation" -d 'Commands to manage the activation of environments: the scripts that run and the environment variables that are set when an environment is activated'
...
complete -c pixi -n "__fish_pixi_using_subcommand help; and __fish_seen_subcommand_from workspace" -f -a "dependencies" -d 'Commands to manage the `[workspace.dependencies]` table'
...
complete -c pixi -n "__fish_pixi_using_subcommand help; and __fish_seen_subcommand_from workspace" -f -a "preview" -d 'Commands to manage workspace preview flags'
