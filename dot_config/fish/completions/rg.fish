...
complete -c rg -n '__fish_use_subcommand'  no-column -d 'Show column numbers.'
...
complete -c rg -n '__fish_use_subcommand'  no-context-separator -d 'Set the separator for contextual chunks.'
...
complete -c rg -n '__fish_use_subcommand'  no-crlf -d 'Use CRLF line terminators (nice for Windows).'
...
complete -c rg -n '__fish_use_subcommand'  no-encoding -d 'Specify the text encoding of files to search.'
...
complete -c rg -n '__fish_use_subcommand'  no-fixed-strings -d 'Treat all patterns as literals.'
complete -c rg -n '__fish_use_subcommand' -s L -l 'follow' -d 'Follow symbolic links.'
complete -c rg -n '__fish_use_subcommand'  no-follow -d 'Follow symbolic links.'
...
complete -c rg -n '__fish_use_subcommand'  no-glob-case-insensitive -d 'Process all glob patterns case insensitively.'
complete -c rg -n '__fish_use_subcommand'  -l 'heading' -d 'Print matches grouped by each file.'
complete -c rg -n '__fish_use_subcommand'  no-heading -d 'Print matches grouped by each file.'
...
complete -c rg -n '__fish_use_subcommand'  no-hidden -d 'Search hidden files and directories.'
...
complete -c rg -n '__fish_use_subcommand'  no-ignore-file-case-insensitive -d 'Process ignore files case insensitively.'
complete -c rg -n '__fish_use_subcommand'  -l 'include-zero' -d 'Include zero matches in summary output.'
complete -c rg -n '__fish_use_subcommand'  no-include-zero -d 'Include zero matches in summary output.'
complete -c rg -n '__fish_use_subcommand' -s v -l 'invert-match' -d 'Invert matching.'
complete -c rg -n '__fish_use_subcommand'  no-invert-match -d 'Invert matching.'
complete -c rg -n '__fish_use_subcommand'  -l 'json' -d 'Show search results in a JSON Lines format.'
complete -c rg -n '__fish_use_subcommand'  no-json -d 'Show search results in a JSON Lines format.'
complete -c rg -n '__fish_use_subcommand'  -l 'line-buffered' -d 'Force line buffering.'
complete -c rg -n '__fish_use_subcommand'  no-line-buffered -d 'Force line buffering.'
...
complete -c rg -n '__fish_use_subcommand'  no-max-columns-preview -d 'Show preview for lines exceeding the limit.'
...
complete -c rg -n '__fish_use_subcommand'  no-mmap -d 'Search with memory maps when possible.'
complete -c rg -n '__fish_use_subcommand' -s U -l 'multiline' -d 'Enable searching across multiple lines.'
complete -c rg -n '__fish_use_subcommand'  no-multiline -d 'Enable searching across multiple lines.'
complete -c rg -n '__fish_use_subcommand'  -l 'multiline-dotall' -d 'Make \'.\' match line terminators.'
complete -c rg -n '__fish_use_subcommand'  no-multiline-dotall -d 'Make \'.\' match line terminators.'
...
complete -c rg -n '__fish_use_subcommand'  ignore -d 'Don\'t use ignore files.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-ignore-dot' -d 'Don\'t use .ignore or .rgignore files.'
complete -c rg -n '__fish_use_subcommand'  ignore-dot -d 'Don\'t use .ignore or .rgignore files.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-ignore-exclude' -d 'Don\'t use local exclusion files.'
complete -c rg -n '__fish_use_subcommand'  ignore-exclude -d 'Don\'t use local exclusion files.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-ignore-files' -d 'Don\'t use --ignore-file arguments.'
complete -c rg -n '__fish_use_subcommand'  ignore-files -d 'Don\'t use --ignore-file arguments.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-ignore-global' -d 'Don\'t use global ignore files.'
complete -c rg -n '__fish_use_subcommand'  ignore-global -d 'Don\'t use global ignore files.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-ignore-messages' -d 'Suppress gitignore parse error messages.'
complete -c rg -n '__fish_use_subcommand'  ignore-messages -d 'Suppress gitignore parse error messages.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-ignore-parent' -d 'Don\'t use ignore files in parent directories.'
complete -c rg -n '__fish_use_subcommand'  ignore-parent -d 'Don\'t use ignore files in parent directories.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-ignore-vcs' -d 'Don\'t use ignore files from source control.'
complete -c rg -n '__fish_use_subcommand'  ignore-vcs -d 'Don\'t use ignore files from source control.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-messages' -d 'Suppress some error messages.'
complete -c rg -n '__fish_use_subcommand'  messages -d 'Suppress some error messages.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-require-git' -d 'Use .gitignore outside of git repositories.'
complete -c rg -n '__fish_use_subcommand'  require-git -d 'Use .gitignore outside of git repositories.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-unicode' -d 'Disable Unicode mode.'
complete -c rg -n '__fish_use_subcommand'  unicode -d 'Disable Unicode mode.'
...
complete -c rg -n '__fish_use_subcommand'  no-one-file-system -d 'Skip directories on other file systems.'
...
complete -c rg -n '__fish_use_subcommand'  no-pcre2 -d 'Enable PCRE2 matching.'
...
complete -c rg -n '__fish_use_subcommand'  no-pre -d 'Search output of COMMAND for each PATH.'
...
complete -c rg -n '__fish_use_subcommand'  no-search-zip -d 'Search in compressed files.'
...
complete -c rg -n '__fish_use_subcommand'  no-stats -d 'Print statistics about the search.'
...
complete -c rg -n '__fish_use_subcommand'  no-text -d 'Search binary files as if they were text.'
...
complete -c rg -n '__fish_use_subcommand'  no-trim -d 'Trim prefix whitespace from matches.'
...
complete -c rg -n '__fish_use_subcommand'  no-auto-hybrid-regex -d '(DEPRECATED) Use PCRE2 if appropriate.'
complete -c rg -n '__fish_use_subcommand'  -l 'no-pcre2-unicode' -d '(DEPRECATED) Disable Unicode mode for PCRE2.'
complete -c rg -n '__fish_use_subcommand'  pcre2-unicode -d '(DEPRECATED) Disable Unicode mode for PCRE2.'
