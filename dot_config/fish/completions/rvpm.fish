...
complete -c rvpm -n "__fish_rvpm_needs_command" -f -a "self-update" -d 'Update the rvpm binary itself to the latest GitHub release (#125)'
...
complete -c rvpm -n "__fish_rvpm_using_subcommand add" -l ai -d 'AI backend for this `add`. Replaces the static-scan + auto-lazy path: the chosen CLI (`claude` / `agy` / `codex` / `opencode`) reads the plugin\'s README + your config and proposes the full `[[plugins]]` block plus any per-plugin hook files. Overrides `options.ai` for this call. `gemini` is deprecated — prefer `agy`, its successor' -r -f -a "off\t'Use the static scan + auto_lazy flow (default)'
claude\t'Spawn the `claude` CLI as a subprocess'
gemini\t'Spawn the `gemini` CLI as a subprocess (deprecated — see `agy`)'
agy\t'Spawn the `agy` (Antigravity) CLI as a subprocess — the Gemini CLI successor'
...
complete -c rvpm -n "__fish_rvpm_using_subcommand tune" -l ai -d 'AI backend for this `tune`. Overrides `options.ai` for this call. `gemini` is deprecated — prefer `agy`, its successor' -r -f -a "off\t'Use the static scan + auto_lazy flow (default)'
claude\t'Spawn the `claude` CLI as a subprocess'
gemini\t'Spawn the `gemini` CLI as a subprocess (deprecated — see `agy`)'
agy\t'Spawn the `agy` (Antigravity) CLI as a subprocess — the Gemini CLI successor'
codex\t'Spawn the `codex` CLI as a subprocess'
...
complete -c rvpm -n "__fish_rvpm_using_subcommand self-update" -s y -l yes -d 'Skip the confirmation prompt'
complete -c rvpm -n "__fish_rvpm_using_subcommand self-update" -l check -d 'Print availability and exit without installing'
complete -c rvpm -n "__fish_rvpm_using_subcommand self-update" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "sync" -d 'Clone/pull plugins and regenerate loader.lua'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "generate" -d 'Regenerate loader.lua only (no git)'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "clean" -d 'Delete plugin directories no longer referenced by config.toml'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "add" -d 'Add a plugin and sync'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "tune" -d 'Tune an existing plugin\'s config with the AI backend'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "edit" -d 'Edit per-plugin or global hook files in $EDITOR'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "set" -d 'Tweak a plugin\'s options interactively'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "update" -d 'Update (git pull) installed plugins'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "remove" -d 'Remove a plugin and delete its directory'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "list" -d 'Show plugin list (TUI by default, plain text with --no-tui)'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "config" -d 'Open config.toml in $EDITOR'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "init" -d 'Print or write the init.lua loader snippet'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "browse" -d 'Browse and install Neovim plugins from GitHub'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "doctor" -d 'Diagnose rvpm\'s config, state, and environment'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "profile" -d 'Profile Neovim startup time per plugin'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "log" -d 'Show recent sync/update/add changes'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "completion" -d 'Print a shell completion script to stdout (#114)'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "self-update" -d 'Update the rvpm binary itself to the latest GitHub release (#125)'
complete -c rvpm -n "__fish_rvpm_using_subcommand help; and not __fish_seen_subcommand_from sync generate clean add tune edit set update remove list config init browse doctor profile log completion self-update help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
