...
function __bin_prepare_completions
    ...
    set -l results (__bin_perform_completion)
    __bin_debug "Completion results: $results"
    ...
    set --global __bin_comp_results $results[1..-2]
...
complete -c bin -n '__bin_prepare_completions' -f -a '$__bin_comp_results'
