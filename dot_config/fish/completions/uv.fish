...
complete -c uv -n "__fish_uv_using_subcommand run" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
complete -c uv -n "__fish_uv_using_subcommand run" -l frozen -d 'Run without updating the `uv.lock` file [env: UV_FROZEN=]'
complete -c uv -n "__fish_uv_using_subcommand run" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand add" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
complete -c uv -n "__fish_uv_using_subcommand add" -l frozen -d 'Add dependencies without re-locking the project [env: UV_FROZEN=]'
complete -c uv -n "__fish_uv_using_subcommand add" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand version" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
...
complete -c uv -n "__fish_uv_using_subcommand version" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand sync" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
complete -c uv -n "__fish_uv_using_subcommand sync" -l frozen -d 'Sync without updating the `uv.lock` file [env: UV_FROZEN=]'
complete -c uv -n "__fish_uv_using_subcommand sync" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand lock" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
...
complete -c uv -n "__fish_uv_using_subcommand lock" -l frozen -d 'Equivalent to `--check-exists`'
complete -c uv -n "__fish_uv_using_subcommand lock" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand export" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
complete -c uv -n "__fish_uv_using_subcommand export" -l frozen -d 'Do not update the `uv.lock` before exporting [env: UV_FROZEN=]'
complete -c uv -n "__fish_uv_using_subcommand export" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand check" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
complete -c uv -n "__fish_uv_using_subcommand check" -l frozen -d 'Sync without updating the `uv.lock` file [env: UV_FROZEN=]'
complete -c uv -n "__fish_uv_using_subcommand check" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand audit" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
...
complete -c uv -n "__fish_uv_using_subcommand audit" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
...
complete -c uv -n "__fish_uv_using_subcommand workspace; and __fish_seen_subcommand_from metadata" -l no-locked -d 'Disable locked mode, overriding `UV_LOCKED`'
...
complete -c uv -n "__fish_uv_using_subcommand workspace; and __fish_seen_subcommand_from metadata" -l no-frozen -d 'Disable frozen mode, overriding `UV_FROZEN`'
