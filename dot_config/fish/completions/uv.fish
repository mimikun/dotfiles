...
function __fish_uv_global_optspecs
	string join \n n/no-cache cache-dir= python-preference= python-fetch= q/quiet v/verbose no-color color= native-tls no-native-tls offline no-offline preview no-preview isolated show-settings no-progress directory= config-file= no-config h/help V/version
end
...
complete -c uv -n "__fish_uv_needs_command" -l python-preference -d 'Whether to prefer using Python installations that are already present on the system, or those that are downloaded and installed by uv' -r -f -a "{only-managed\t'Only use managed Python installations; never use system Python installations',managed\t'Prefer managed Python installations over system Python installations',system\t'Prefer system Python installations over managed Python installations',only-system\t'Only use system Python installations; never use managed Python installations'}"
complete -c uv -n "__fish_uv_needs_command" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_needs_command" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_needs_command" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_needs_command" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_needs_command" -f -a "init" -d 'Create a new project (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "run" -d 'Run a command in an environment (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "sync" -d 'Update the project\'s environment to match the project\'s dependencies (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "lock" -d 'Create or update a lockfile for the project\'s dependencies (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "add" -d 'Add one or more packages to the project\'s dependencies (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "remove" -d 'Remove one or more packages from the project\'s dependencies (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "tree" -d 'Display the dependency tree for the project (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "venv" -d 'Create a virtual environment'
complete -c uv -n "__fish_uv_needs_command" -f -a "cache" -d 'Manage the cache'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and not __fish_seen_subcommand_from compile sync install uninstall freeze list show tree check" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand pip; and not __fish_seen_subcommand_from compile sync install uninstall freeze list show tree check" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and not __fish_seen_subcommand_from compile sync install uninstall freeze list show tree check" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and not __fish_seen_subcommand_from compile sync install uninstall freeze list show tree check" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -s P -l upgrade-package -d 'Allow upgrades for a specific package, ignoring pinned versions in any existing output file' -r
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -l python -d 'The Python interpreter against which to compile the requirements.' -r
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -s p -l python-version -d 'The minimum Python version that should be supported by the resolved requirements (e.g., `3.8` or `3.8.17`)' -r
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -s U -l upgrade -d 'Allow package upgrades, ignoring pinned versions in any existing output file'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -l legacy-setup-py -d 'Use legacy `setuptools` behavior when building source distributions without a `pyproject.toml`'
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -l no-legacy-setup-py
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -l no-progress -d 'Hides all progress outputs when set'
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -s h -l help -d 'Print help'
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from compile" -s V -l version -d 'Print version'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -l legacy-setup-py -d 'Use legacy `setuptools` behavior when building source distributions without a `pyproject.toml`'
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -l no-legacy-setup-py
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -l no-progress -d 'Hides all progress outputs when set'
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -s h -l help -d 'Print help'
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from sync" -s V -l version -d 'Print version'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from install" -l legacy-setup-py -d 'Use legacy `setuptools` behavior when building source distributions without a `pyproject.toml`'
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from install" -l no-legacy-setup-py
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from install" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from install" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from install" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from uninstall" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from uninstall" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from uninstall" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from freeze" -l system -d 'List packages for the system Python'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from freeze" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from freeze" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from freeze" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from list" -l system -d 'List packages for the system Python'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from list" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from list" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from list" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from show" -l system -d 'List packages for the system Python'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from show" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from show" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from show" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from tree" -l system -d 'List packages for the system Python'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from tree" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from tree" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from tree" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from check" -l system -d 'List packages for the system Python'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from check" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from check" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand pip; and __fish_seen_subcommand_from check" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l cache-dir -d 'Path to the cache directory' -r -F
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l python-preference -d 'Whether to prefer using Python installations that are already present on the system, or those that are downloaded and installed by uv' -r -f -a "{only-managed\t'Only use managed Python installations; never use system Python installations',managed\t'Prefer managed Python installations over system Python installations',system\t'Prefer system Python installations over managed Python installations',only-system\t'Only use system Python installations; never use managed Python installations'}"
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l directory -d 'Change to the given directory prior to running the command' -r -F
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l config-file -d 'The path to a `uv.toml` file to use for configuration' -r -F
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -s q -l quiet -d 'Do not print any output'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -s v -l verbose -d 'Use verbose output'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l native-tls -d 'Whether to load TLS certificates from the platform\'s native certificate store'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l no-native-tls
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l no-offline
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l preview -d 'Whether to enable experimental, preview features'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l no-preview
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -f -a "uvx" -d 'Run a tool.'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -f -a "install" -d 'Install a tool'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -f -a "list" -d 'List installed tools'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -f -a "uninstall" -d 'Uninstall a tool'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -f -a "update-shell" -d 'Ensure that the tool executable directory is on `PATH`'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -f -a "dir" -d 'Show the tools directory'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from run" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from run" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from uvx" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from uvx" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from install" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from install" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from install" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from list" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from list" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from list" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from uninstall" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from uninstall" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from uninstall" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from update-shell" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from update-shell" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from update-shell" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from dir" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from dir" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and __fish_seen_subcommand_from dir" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand python; and not __fish_seen_subcommand_from list install find pin dir uninstall" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand python; and not __fish_seen_subcommand_from list install find pin dir uninstall" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand python; and not __fish_seen_subcommand_from list install find pin dir uninstall" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand python; and not __fish_seen_subcommand_from list install find pin dir uninstall" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from list" -l all-versions -d 'List all Python versions, including outdated patch versions'
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from list" -l all-platforms -d 'List Python installations for all platforms'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from list" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from list" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from list" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from install" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from install" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from install" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from find" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from find" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from find" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from pin" -l no-workspace -d 'Avoid validating the Python pin against the workspace in the current directory or any parent directory'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from pin" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from pin" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from pin" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from dir" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from dir" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from dir" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from uninstall" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from uninstall" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand python; and __fish_seen_subcommand_from uninstall" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand init" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand init" -l no-workspace -d 'Avoid discovering the workspace in the current directory or any parent directory. Instead, create a standalone project'
...
complete -c uv -n "__fish_uv_using_subcommand init" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand init" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand init" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand run" -s p -l python -d 'The Python interpreter to use to build the run environment.' -r
...
complete -c uv -n "__fish_uv_using_subcommand run" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand run" -l isolated -d 'Run the tool in an isolated virtual environment, rather than leveraging the base environment for the current project, to enforce strict isolation between dependencies'
complete -c uv -n "__fish_uv_using_subcommand run" -l locked -d 'Assert that the `uv.lock` will remain unchanged'
complete -c uv -n "__fish_uv_using_subcommand run" -l frozen -d 'Install without updating the `uv.lock` file'
...
complete -c uv -n "__fish_uv_using_subcommand run" -l no-project -d 'Avoid discovering the project or workspace in the current directory or any parent directory. Instead, run in an isolated, ephemeral environment populated by the `--with` requirements'
...
complete -c uv -n "__fish_uv_using_subcommand run" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand run" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand sync" -l package -d 'Sync a specific package in the workspace' -r
...
complete -c uv -n "__fish_uv_using_subcommand sync" -l no-clean -d 'Does not clean the environment'
complete -c uv -n "__fish_uv_using_subcommand sync" -l locked -d 'Assert that the `uv.lock` will remain unchanged'
complete -c uv -n "__fish_uv_using_subcommand sync" -l frozen -d 'Install without updating the `uv.lock` file'
...
complete -c uv -n "__fish_uv_using_subcommand sync" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand sync" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand sync" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand lock" -s P -l upgrade-package -d 'Allow upgrades for a specific package, ignoring pinned versions in any existing output file' -r
...
complete -c uv -n "__fish_uv_using_subcommand lock" -s U -l upgrade -d 'Allow package upgrades, ignoring pinned versions in any existing output file'
...
complete -c uv -n "__fish_uv_using_subcommand lock" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand lock" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand lock" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand add" -l rev -d 'Specific commit to use when adding from Git' -r
complete -c uv -n "__fish_uv_using_subcommand add" -l tag -d 'Tag to use when adding from git' -r
complete -c uv -n "__fish_uv_using_subcommand add" -l branch -d 'Branch to use when adding from git' -r
complete -c uv -n "__fish_uv_using_subcommand add" -l extra -d 'Extras to activate for the dependency; may be provided more than once' -r
...
complete -c uv -n "__fish_uv_using_subcommand add" -s p -l python -d 'The Python interpreter into which packages should be installed.' -r
...
complete -c uv -n "__fish_uv_using_subcommand add" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand add" -l frozen -d 'Add the requirements without updating the `uv.lock` file'
...
complete -c uv -n "__fish_uv_using_subcommand add" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand add" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand add" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l package -d 'Remove the dependency from a specific package in the workspace' -r
complete -c uv -n "__fish_uv_using_subcommand remove" -s p -l python -d 'The Python interpreter into which packages should be installed.' -r
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l dev -d 'Remove the requirements from development dependencies'
complete -c uv -n "__fish_uv_using_subcommand remove" -l locked -d 'Assert that the `uv.lock` will remain unchanged'
complete -c uv -n "__fish_uv_using_subcommand remove" -l frozen -d 'Remove the requirements without updating the `uv.lock` file'
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand remove" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -s P -l upgrade-package -d 'Allow upgrades for a specific package, ignoring pinned versions in any existing output file' -r
...
complete -c uv -n "__fish_uv_using_subcommand tree" -s p -l python -d 'The Python interpreter for which packages should be listed.' -r
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l show-version-specifiers -d 'Show the version constraint(s) imposed on each package'
complete -c uv -n "__fish_uv_using_subcommand tree" -l locked -d 'Assert that the `uv.lock` will remain unchanged'
complete -c uv -n "__fish_uv_using_subcommand tree" -l frozen -d 'Display the requirements without updating the `uv.lock` file'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -s U -l upgrade -d 'Allow package upgrades, ignoring pinned versions in any existing output file'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand venv" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand venv" -l system -d 'Use the system Python to uninstall packages'
complete -c uv -n "__fish_uv_using_subcommand venv" -l no-system
...
complete -c uv -n "__fish_uv_using_subcommand venv" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand venv" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand venv" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and not __fish_seen_subcommand_from clean prune dir" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand cache; and not __fish_seen_subcommand_from clean prune dir" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and not __fish_seen_subcommand_from clean prune dir" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and not __fish_seen_subcommand_from clean prune dir" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from clean" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from clean" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from clean" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from prune" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from prune" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from prune" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from dir" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from dir" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand cache; and __fish_seen_subcommand_from dir" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand self; and not __fish_seen_subcommand_from update" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand self; and not __fish_seen_subcommand_from update" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand self; and not __fish_seen_subcommand_from update" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand self; and not __fish_seen_subcommand_from update" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand self; and __fish_seen_subcommand_from update" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand self; and __fish_seen_subcommand_from update" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand self; and __fish_seen_subcommand_from update" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand clean" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand clean" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand clean" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand clean" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand version" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand version" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand version" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand version" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l cache-dir -d 'Path to the cache directory' -r -F
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l python-preference -d 'Whether to prefer using Python installations that are already present on the system, or those that are downloaded and installed by uv' -r -f -a "{only-managed\t'Only use managed Python installations; never use system Python installations',managed\t'Prefer managed Python installations over system Python installations',system\t'Prefer system Python installations over managed Python installations',only-system\t'Only use system Python installations; never use managed Python installations'}"
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l config-file -d 'The path to a `uv.toml` file to use for configuration' -r -F
...
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -s q -l quiet -d 'Do not print any output'
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -s v -l verbose -d 'Use verbose output'
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l native-tls -d 'Whether to load TLS certificates from the platform\'s native certificate store'
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l no-native-tls
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
...
complete -c uv -n "__fish_uv_using_subcommand help" -l python-fetch -d 'Whether to automatically download Python when required' -r -f -a "{automatic\t'Automatically fetch managed Python installations when needed',manual\t'Do not automatically fetch managed Python installations; require explicit installation'}"
...
complete -c uv -n "__fish_uv_using_subcommand help" -l no-color -d 'Disable colors; provided for compatibility with `pip`'
...
complete -c uv -n "__fish_uv_using_subcommand help" -l offline -d 'Disable network access, relying only on locally cached data and locally available files'
...
complete -c uv -n "__fish_uv_using_subcommand help" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file in the current directory or any parent directories'
