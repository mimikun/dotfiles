...
complete -c uv -n "__fish_uv_needs_command" -f -a "run" -d 'Run a command or script (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "init" -d 'Create a new project (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "add" -d 'Add dependencies to the project (experimental)'
complete -c uv -n "__fish_uv_needs_command" -f -a "remove" -d 'Remove dependencies from the project (experimental)'
...
complete -c uv -n "__fish_uv_using_subcommand sync" -l no-clean -d 'When syncing, make the minimum necessary changes to satisfy the requirements'
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l python-platform -d 'The platform to use when filtering the tree' -r -f -a "{windows\t'An alias for `x86_64-pc-windows-msvc`, the default target for Windows',linux\t'An alias for `x86_64-unknown-linux-gnu`, the default target for Linux',macos\t'An alias for `aarch64-apple-darwin`, the default target for macOS',x86_64-pc-windows-msvc\t'An x86 Windows target',x86_64-unknown-linux-gnu\t'An x86 Linux target. Equivalent to `x86_64-manylinux_2_17`',aarch64-apple-darwin\t'An ARM-based macOS target, as seen on Apple Silicon devices',x86_64-apple-darwin\t'An x86 macOS target',aarch64-unknown-linux-gnu\t'An ARM64 Linux target. Equivalent to `aarch64-manylinux_2_17`',aarch64-unknown-linux-musl\t'An ARM64 Linux target',x86_64-unknown-linux-musl\t'An `x86_64` Linux target',x86_64-manylinux_2_17\t'An `x86_64` target for the `manylinux_2_17` platform',x86_64-manylinux_2_28\t'An `x86_64` target for the `manylinux_2_28` platform',x86_64-manylinux_2_31\t'An `x86_64` target for the `manylinux_2_31` platform',aarch64-manylinux_2_17\t'An ARM64 target for the `manylinux_2_17` platform',aarch64-manylinux_2_28\t'An ARM64 target for the `manylinux_2_28` platform',aarch64-manylinux_2_31\t'An ARM64 target for the `manylinux_2_31` platform'}"
...
complete -c uv -n "__fish_uv_using_subcommand tree" -l universal -d 'Show the resolved package versions for all Python versions and platforms, rather than filtering to those that are relevant for the current environment'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l no-color -d 'Disable colors'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l offline -d 'Disable network access'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l isolated -d 'Avoid discovering a `pyproject.toml` or `uv.toml` file'
...
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l no-progress -d 'Hide all progress outputs'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -l no-config -d 'Avoid discovering configuration files (`pyproject.toml`, `uv.toml`)'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -s h -l help -d 'Display the concise help for this command'
complete -c uv -n "__fish_uv_using_subcommand tool; and not __fish_seen_subcommand_from run uvx install list uninstall update-shell dir" -s V -l version -d 'Display the uv version'
...
complete -c uv -n "__fish_uv_using_subcommand venv" -l system
...
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l offline -d 'Disable network access'
...
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l no-progress -d 'Hide all progress outputs'
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l no-config -d 'Avoid discovering configuration files (`pyproject.toml`, `uv.toml`)'
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -s h -l help -d 'Display the concise help for this command'
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -s V -l version -d 'Display the uv version'
