...
complete -c uv -n "__fish_uv_using_subcommand sync" -l no-clean -d 'Do not remove extraneous packages'
...
complete -c uv -n "__fish_uv_using_subcommand generate-shell-completion" -l no-python-downloads -d 'Disable automatic downloads of Python'
