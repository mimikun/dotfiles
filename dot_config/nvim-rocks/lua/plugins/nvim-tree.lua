...
local preview_opts = {
    ...
    max_width = 85,
    max_height = 25,
    -- Whether to wrap lines in the preview window
    wrap = false,
    -- Border style for the preview window
    border = "rounded",
    -- Stacking order. Increase if the preview window is shown below other windows.
    zindex = 100,
    -- Whether to show the file name as the title of the preview window
    show_title = true,
