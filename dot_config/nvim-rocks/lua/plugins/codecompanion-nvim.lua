...
vim.keymap.set({ "n", "v" }, "<C-a>", "<cmd>CodeCompanionActions<cr>", key_opts)

vim.keymap.set({ "n", "v" }, "<LocalLeader>a", "<cmd>CodeCompanionChat Toggle<cr>", key_opts)

vim.keymap.set("v", "ga", "<cmd>CodeCompanionChat Add<cr>", key_opts)
