...
cp ~/.config/fish/pez.toml ./dot_config/fish/pez.toml
...
chezmoi add ~/.config/gup/gup.json
...
chezmoi add ~/.brow6el/browser.conf
chezmoi add ~/.brow6el/cef_flags.conf
chezmoi add ~/.brow6el/userscripts.conf
